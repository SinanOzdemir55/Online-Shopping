...
var listVegan = document.querySelector("#listVegan");
var listDairy = document.querySelector("#listDairy");
var listBakery = document.querySelector("#listBakery");
var listMeat = document.querySelector("#listMeat");
var listVegetable = document.querySelector("#listVegetable");
var listFruit = document.querySelector("#listFruit");
...
var sectionVegan = document.querySelector("#sectionVegan")
var sectionDairy = document.querySelector("#sectionDairy")
var sectionBakery = document.querySelector("#sectionBakery")
var sectionMeat = document.querySelector("#sectionMeat")
var sectionVegetable = document.querySelector("#sectionVegetable")
var sectionFruit = document.querySelector("#sectionFruit")


var list = document.querySelectorAll("#list")

listVegan.onclick = function () {

    if (sectionVegan.style.display != 'block') {
        sectionVegan.style.display = 'block';
    } else {
        sectionVegan.style.display = 'none';
    }

}


listDairy.onclick = function () {

    if (sectionDairy.style.display != 'block') {
        sectionDairy.style.display = 'block';
    } else {
        sectionDairy.style.display = 'none';
    }

}
listBakery.onclick = function () {

    if (sectionBakery.style.display != 'block') {
        sectionBakery.style.display = 'block';
    } else {
        sectionBakery.style.display = 'none';
    }

}


listMeat.onclick = function () {

    if (sectionMeat.style.display != 'block') {
        sectionMeat.style.display = 'block';
    } else {
        sectionMeat.style.display = 'none';
    }

}
listVegetable.onclick = function () {

    if (sectionVegetable.style.display != 'block') {
        sectionVegetable.style.display = 'block';
    } else {
        sectionVegetable.style.display = 'none';
    }

}


listFruit.onclick = function () {

    if (sectionFruit.style.display != 'block') {
...
$(document).ready(function () {
    ...
    var products = [{
        ...
        "title": "Baked stuffed portabello",
        "type": "bakery",
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].type == "vegetable") {


            $("#sectionVegetable").append(baslik);
        }
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].type == "bakery") {


            $("#sectionBakery").append(baslik);
        }
    ...
    var baslik = "<li>";
    sectionFruit.onclick = function () {
        for (var i = 0; i < data.length; i++) {
            if (data[i].type == "fruit"){
                var subcategory=data[i].title;
                alert(subcategory);
                break;
            }
